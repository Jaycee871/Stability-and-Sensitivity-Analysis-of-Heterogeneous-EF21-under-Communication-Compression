...
CITATION_NUMBERS = {
    "seide2014onebit": 1,
    "stich2018sparsified": 2,
    "karimireddy2019error": 3,
    "richtarik2021ef21": 4,
    "thomsen2026tight": 5,
    "drori2014performance": 6,
    "taylor2017exact": 7,
}
...
def build_manuscript() -> str:
    ...
    methods_disclosure = (
        ...
        "verification planning, and manuscript preparation. ChatGPT (OpenAI; GPT-5.6 Sol) assisted in drafting "
        ...
        "solely on the basis of language-model output. All outputs were reviewed by the human authors.\n\n"
    )
...
The complete computational workflow, generated numerical outputs, analysis scripts, and figure-building code will be archived in a publicly accessible repository before final submission. Permanent archive identifier: [PUBLIC ARCHIVE URL/DOI REQUIRED BEFORE SUBMISSION].
...
def main() -> None:
    ...
    report = {
        ...
        "notes": [
            ...
            "Research results are unchanged from the audited Phase 1-7 pipeline.",
        ],
    }
